...
export default function Home() {
  return (
    <main className="flex h-full flex-col">
      <div className="flex flex-col md:flex-row h-full bg-slate-300">
        <Image src={pizza} className="w-full rounded-s-md h-1/2 md:h-full md:w-1/2" alt="pizza"/>
        <div className="flex flex-col justify-center items-center border-l-2 px-2 h-1/2 md:h-full md:w-1/2">
